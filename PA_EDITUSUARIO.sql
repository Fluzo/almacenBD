create PROCEDURE PA_EDITUSUARIO
(
	@ID_USUARIO INT,
	@PASSWORD VARCHAR(50),
	@EMAIL VARCHAR(100),
...
BEGIN TRY 
	...
	BEGIN
		UPDATE USUARIOS SET EMAIL = @EMAIL, PASSWORD = @PASSWORD, ACTIVO = ISNULL(@ACTIVO,0), ID_PERFIL = @ID_PERFIL WHERE ID_USUARIO = @ID_USUARIO;
		SET @RETCODE = 0
	END
